...
<div id="hallWrapper">
  ...
  　　可能です</p>
    ...
    <div id="gyosha">
      <h5>関係先指定業者</h5>
      <ul>
        <li>ビューティー花壇<br>（生花祭壇・供花）</li>
        <li>春夏秋冬<br>（料理全般）</li>
        <li>東京あじよし商事<br>（受付用具・案内板・収骨容器）</li>
      </ul>
    </div>
  ...
  <div id="priceTable">
    <table>
      ...
      <tr>
        <td>15：00～翌14:00</td>
        <td>110,000円（税込）</td>
        <td>寝台車・保管料金は別途<br>親族の宿泊は出来ません</td>
      </tr>
    </table>
  ...
  <div id="nearKasoba">
    ...
    <div id="nearWrapper">
      ...
      <table>
        ...
        <tr><td>12歳未満</td><td>8,000円</td><td>34,000円</td></tr>
      </table>

    </div>
   <p>※当ホールに最寄りの火葬場は、かわさき北部斎苑（JR南武線「津田山」駅）です。</p> 
  </div>
</div><!-- hallWrapperEnd -->
