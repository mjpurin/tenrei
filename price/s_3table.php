  ...
  <tbody>
    <tr>
      ...
      <td width="336" rowspan="4" align="right" valign="top">
        ...
        <tbody>
        <tr valign="bottom">
          <td height="151" style="padding-top:16px;"><div align="center"><img src="img/s3_01_new.jpg" width="400" height="238"></div>
          </td>
        </tr>
        <!--写真-->
        <tr>
        ...
        <!--gallaryボタン-->
        <tr>
          <td height="35" align="center" valign="bottom"><a href="#"><img src="img/photoup_btn.gif" alt="" width="129" height="29" border="0" onclick="MM_openBrWindow('s_3_zoom.html','zoom','scrollbars=no,resizable=yes')"></a>
          </td>
        </tr>
        <tr>
          <td align="center">&nbsp;</td>
      ...
      <td width="220">
        <table width="168" border="1">
          <tbody>
            ...
            <tr>
              <td style="border:1px solid #000;text-align:center;font-size:18px;padding:5px;font-weight:bold;">Ｓ－３</td>
            </tr>
              </tbody>
            </table>
          </td>
            <td>
                <table>
                  ...
                  <tr>
                    <td style="border:1px solid #000;text-align:center;font-size:18px;padding:5px 20px;font-weight:bold;">6,600,000円</td>
                  </tr>
                </tbody></table>
        ...
        6,600,000＋660,000＋135,750＋300,000＝7,695,750円です。（税込）<br>
